...
Candidates can be assessed before their deadline or permissionlessly expired afterward. Duplicate IDs, source reuse, forged digests and invalid transitions are rejected. Run `python -m pytest -q` and `genvm-lint contract/release_prism.py`.
